...
interface ListerStepThreeProps {
  data: OnboardingData;
...
export const ListerStepThree = ({ data, onComplete, onBack }: ListerStepThreeProps) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <Textarea
            ...
            placeholder="Πείτε μας λίγα λόγια για εσάς, τα ενδιαφέροντά σας, τι κάνει το χώρο σας ιδανικό..."
